...
class modul11_praktik1_SingleList { // FIX 2: semua method masuk ke dalam class ini
    ...
    public static void main(String[] args) {
        ...
        tambahBelakang();
        cetakSenarai();
        mengurutkanDataBubble_TeknikTukarNilai_singleList();
        cetakSenarai();
        ...
        tambahBelakang();
        cetakSenarai();
        mengurutkanDataBubble_TeknikTukarHeap_singleList();
        cetakSenarai();
